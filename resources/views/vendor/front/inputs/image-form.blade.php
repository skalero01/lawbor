<div class="p-5 text-white bg-gray-700 dark:bg-gray-800 my-3 text-center">
    <div class="card-body" id="{{ $id }}">
        ...
        @endif
        <p class="file-name"></p>
        <button type="button" class="btn btn-secondary dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white" onclick="executeFile('{{ $id }}')">{{ __('Upload Image') }}</button>
